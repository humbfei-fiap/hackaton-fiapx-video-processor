...
from src.ports.interfaces import VideoRepository, VideoProcessor
import os

class ProcessVideoUseCase:
    def __init__(self, video_repo: VideoRepository, processor: VideoProcessor, uploads_dir: str, outputs_dir: str):
